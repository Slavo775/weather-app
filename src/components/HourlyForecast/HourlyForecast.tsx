...
export default function HourlyForecast({hours}: {hours: ForecastWeatherHourResponse[]}) {
    ...
    const activeHourIndex = useMemo(() => hoursLocal.findIndex((hour) => isActive(hour.date)), [nearestTextHourDate])
    ...
    return (
        ...
        >
            <Slider style={{gap: '14px'}}>
                ...
                <Slide index={0}><div className={'hourly-forecast__empty-slide'}></div></Slide>
